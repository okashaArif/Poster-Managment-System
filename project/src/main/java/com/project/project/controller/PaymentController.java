...
public class PaymentController {
    ...
    @PostMapping("/refund")
    public ResponseEntity<String> processRefund(@RequestBody Payment payment) {
        // Refund logic here
    ...
    @GetMapping("/failure")
    public ResponseEntity<List<Payment>> listFailedTransactions() {
        // Logic to list failed transactions
        return ResponseEntity.ok(paymentRepository.findAll()); // Modify as needed
    }

    @GetMapping("/success")
    public ResponseEntity<List<Payment>> listSuccessfulTransactions() {
